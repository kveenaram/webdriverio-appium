 ...
 * @see {@link Check}
 */
class Expectation extends core_1.Question {
    /**
     * @desc
    ...
    answeredBy(actor) {
        return (actual) => actor.answer(this.expectedValue)
            ...
            return this.predicate(actual, expected)
                ? new outcomes_1.ExpectationMet(this.toString(), expected, actual)
                : new outcomes_1.ExpectationNotMet(this.toString(), expected, actual);
        });
    }
}
/**
...
class ExpectationAlias extends Expectation {
    ...
    answeredBy(actor) {
        return (actual) => this.expectation.answeredBy(actor)(actual).then(_ => _ instanceof outcomes_1.ExpectationMet
            ? new outcomes_1.ExpectationMet(this.subject, _.expected, _.actual)
            : new outcomes_1.ExpectationNotMet(_.message, _.expected, _.actual));
    }
}
