...
class Ensure extends core_1.Interaction {
    ...
    performAs(actor) {
        return Promise.all([
            ...
            .when(outcomes_1.ExpectationNotMet, o => {
            actor.collect(this.artifactFrom(o.expected, o.actual), new model_1.Name(`Assertion Report`));
            throw this.errorForOutcome(o);
        })
            .when(outcomes_1.ExpectationMet, _ => void 0)
            .else(o => {
            throw new core_1.LogicError(io_1.formatted `An Expectation should return an instance of an Outcome, not ${o}`);
        })));
    }
    /**
     * @desc
