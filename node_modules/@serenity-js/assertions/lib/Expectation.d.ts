 ...
 */
export declare type Predicate<A, E> = (actual: A, expected: E) => boolean;
/**
 * @desc
 ...
 * @see {@link Check}
 */
export declare abstract class Expectation<Expected, Actual = Expected> extends Question<(actual: Actual) => Promise<Outcome<Expected, Actual>>> {
    /**
     * @desc
